...
public class FranchiseOfferController {
    ...
    // individual
    @PutMapping("/individual/make-franchise-offer/{individualId}/{franchiseId}")
    ...
    @PutMapping("/individual/make-counter-franchise-offer/{individualId}/{franchiseId}")
    ...
    @GetMapping("/owner/offer-wait-response/{ownerId}")
    public ResponseEntity<?> getOfferWaitResponseOwner(@PathVariable Integer ownerId) {
        return ResponseEntity.status(200).body(franchiseOfferService.getOwnerFranchiseOfferWaitResponse(ownerId));
