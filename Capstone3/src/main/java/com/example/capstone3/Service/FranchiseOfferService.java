...
public class  FranchiseOfferService {
    ...
    public void individualMakeOfferSameDeal(Integer individualId,Integer franchiseId) {
        ...
        if (franchiseOffers.isEmpty() && franchiseOfferPendingByIndividual.isEmpty()) throw new ApiException("you have active offer");
    ...
    public void individualCounterOwnerOffer(Integer individualId,Integer offerId, Integer franchiseId, FranchiseOfferIn franchiseOfferIn){
        ...
        if (oldFranchiseOffer.getStatus().equals("Pending by owner") ) throw new ApiException("Cannot offer same deal again");
    ...
    public List<FranchiseOfferDTO> getOwnerFranchiseOfferWaitResponse(Integer ownerId){
        Owner owner = ownerRepository.findOwnerById(ownerId);
        if (owner == null) {
            throw new ApiException("owner not found");
        }

        List<FranchiseOffer> franchiseOffer = franchiseOfferRepository.findFranchiseOfferByIndividualIdAndStatus(ownerId,"Pending by owner");
